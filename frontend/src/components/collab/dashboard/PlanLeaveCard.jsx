...
export function PlanLeaveCard({ availableDays, periodLabel, onNewRequest }) {
  return (
    <section className="plan-card">
      ...
      {availableDays !== null && (
        <p className="plan-card__balance">Solde {periodLabel ? `(${periodLabel})` : 'de la période'} : {formatDays(availableDays)} j</p>
      )}
